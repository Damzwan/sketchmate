<template>
  <ion-popover :showBackdrop="false" :is-open="selectMoreOptionsMenuOpen" :event="menuEvent"
               @didDismiss="selectMoreOptionsMenuOpen=false">
    <ion-content>
      <ion-list lines="none" class="divide-y divide-primary p-0">
        ...
        <ion-item color="tertiary" :button="true" @click="flipX">
          <ion-icon :icon="svg(mdiFlipHorizontal)" />
          <p class="pl-2 text-base">Flip X</p>
        </ion-item>

        <ion-item color="tertiary" :button="true" @click="flipY">
