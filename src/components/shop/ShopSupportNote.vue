<template>
  <div class="flex items-start gap-3">
    ...
    <div class="relative flex-1 min-w-0 rounded-2xl rounded-tl-sm border border-primary/40 bg-tertiary px-3.5 py-2.5">
      ...
      <p class="text-lg font-black text-black leading-none">SketchMate Big Boss</p>
      <p class="text-base leading-snug mt-1.5">
        Hey! I'm the solo developer behind SketchMate. I spent <span class="text-secondary font-black">1,000+ hours</span>
