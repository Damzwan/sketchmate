...
import { createBalloon } from "@/service/api/balloon.api";
...
export function useDrawSendService(c: () => Canvas | null) {
	...
	async function createBalloonHelper(
		message: string,
		optionalData?: {
			img?: ArrayBuffer;
			canvas?: string;
	...
	return { send, createBalloon: createBalloonHelper, isSendingDrawing };
}
