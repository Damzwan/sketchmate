import { BaseBrush, Canvas, FabricImage, Path, Point, Shadow, SprayBrushPoint } from 'fabric'
...
export class FastSprayBrush extends BaseBrush {
  ...
  declare private sprayDots: SprayBrushPoint[]
  declare private latestChunkStart: number
