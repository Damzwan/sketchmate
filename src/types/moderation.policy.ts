...
export const STRIKE_LADDER = [
	...
	},
	{
		...
		name: "Balloon Pause",
		description:
			"Your balloon privileges are paused for 7 days. You can still post, chat, and draw with mates.",
		blocks: [
	...
	},
	{
		...
		description:
			"Most features are paused while we review your account. Contact support to appeal.",
		blocks: [
			Capability.CREATE_POST,
			Capability.COMMENT_ON_POST,
			Capability.SEND_BALLOON,
