  ...
  <ion-page class="slide-page">
    ...
    <ion-content class="--background-custom">
      <div class="w-full max-w-2xl mx-auto px-4 pt-4 flex flex-col min-h-full bot-pad-safe">
        ...
        <!-- ─── Tab Segment Header (Updated order to match layout settings) ─── -->
        ...
        >
          ...
          <div class="flex items-baseline justify-between px-1 mb-4 select-none">
            ...
            <span v-if="currentList.length" class="text-[10px] font-black text-[var(--ion-color-dark)]/40 uppercase tracking-widest">
          ...
          <!-- Dynamic Interacting User List Feed -->
          <div v-else-if="currentList.length > 0" class="space-y-2.5">
            ...
            >
              ...
              <div class="relative shrink-0 w-11 h-11 flex items-center justify-center select-none">
                ...
                <!-- Pending Status Micro Alert Tag -->
                <div
              ...
              <!-- Meta Descriptions Identity Stack -->
              ...
              <!-- Expiry Countdown Counter Overlay context -->
          ...
          <!-- Empty Sketchbook Fallback State Panel -->
          ...
          <ion-infinite-scroll @ionInfinite="loadMore" :disabled="!hasMore" threshold="20%">
